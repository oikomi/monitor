srcdir = /mh/phphook/phpmonitor
builddir = /mh/phphook/phpmonitor
top_srcdir = /mh/phphook/phpmonitor
top_builddir = /mh/phphook/phpmonitor
EGREP = /bin/grep -E
SED = /bin/sed
...
RE2C = exit 0;
AWK = gawk
shared_objects_phpmonitor = phpmonitor.lo
PHP_PECL_EXTENSION = phpmonitor
PHP_MODULES = $(phplibdir)/phpmonitor.la
PHP_ZEND_EX =
all_targets = $(PHP_MODULES) $(PHP_ZEND_EX)
install_targets = install-modules install-headers
prefix = /mh/phphook/php
exec_prefix = $(prefix)
libdir = ${exec_prefix}/lib
prefix = /mh/phphook/php
phplibdir = /mh/phphook/phpmonitor/modules
phpincludedir = /mh/phphook/php/include/php
CC = cc
CFLAGS = -g -O2
CFLAGS_CLEAN = $(CFLAGS)
CPP = cc -E
...
EXTENSION_DIR = /mh/phphook/php/lib/php/extensions/no-debug-non-zts-20121212
